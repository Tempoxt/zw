...
export default {
    ...
    methods: {
        ...
        async export () {
            ...
            const export_file = async(type) => {
                ...
                if (type === 'pdf') {
                    ...
                    pdf.html(document.querySelector('.el-table'), {
            ...
            this.$alert( <el-button-group>
                ...
                onClick = {
                    () => { export_file('xlsx') }
                } > XLSX </el-button> <el-button type = "primary"
                icon = "el-icon-document"
                onClick = {
                    () => { export_file('txt') }
                } > TXT </el-button> <el-button type = "primary"
                icon = "el-icon-document"
                onClick = {
                    () => { export_file('csv') }
                } > CSV </el-button> </el-button-group> , '选择导出格式', {
        ...
        import () {
            ...
            MessageBox.alert( <el-button-group class = "table-import-upload"
                v-loading = { this.importLoading } >
                <el-button type = "primary"
                onClick = {
                    () => {}
                } > 选择文件 </el-button> <input type = "file"
                ref = "input"
                class = "input"
                on-change = { handleImportChange }
                ref = "importInput" > </input> </el-button-group> , '选择文件导入', {
                    showConfirmButton: false,
                    center: true
                });
        },
