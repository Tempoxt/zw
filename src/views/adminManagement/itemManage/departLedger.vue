       ...
       <el-col :span="4" class="h-full">
        ...
        <el-col :span="20" style="border-left:1px solid rgb(232, 232, 232)">
            ...
            <div v-if="view_activeName==='部门管理员'">
                <departLedgerTable url="toolstationery/departledgermanager" :orgid="orgid" :name="depart_name"/>
            </div>
            <div v-if="view_activeName==='部门台账'">
                <departLedgerTable url="toolstationery/departledger" :orgid="orgid"/>
            </div>
            <div v-if="view_activeName==='组长管理'">
                <departLedgerTable url="toolstationery/special" :orgid="orgid"/>
            </div>
        </el-col>
    </el-row>
</template>
