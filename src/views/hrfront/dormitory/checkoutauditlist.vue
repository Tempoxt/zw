    ...
    <each-table-column :table_field="table_field"/>
     <el-table-column
        ...
        <template slot-scope="scope">
            <el-button @click="audit({row:scope.row})" type="text" size="small" >审核</el-button>
        </template>
    </el-table-column>
...
const api_resource = api_common.resource("dormitory/checkoutauditlist");
...
export default {
  ...
  async created() {
    const { field, action,table } = await api_common.menuInit("dormitory/checkoutauditlist");
