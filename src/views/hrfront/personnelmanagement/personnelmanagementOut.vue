    ...
    <div>
      ...
      >
        ...
        <div class="drawer-profile">
          <el-row>
            ...
            <el-col :span="12" class="alignStart">
              ...
              <span class="labelCon promp addr">
                {{ profileData.contactAddr }}
              </span>
            </el-col>
            <el-col :span="12">
        ...
        <div class="drawer-profile">
          <el-row>
            ...
            <el-col :span="12">
              ...
              <span class="labelCon promp">
                {{ profileData.socialSecurityMain }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">试用期限：</span>
              <span class="labelCon promp">
                {{ profileData.trialTimeShow }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">所属部门：</span>
              <span class="labelCon promp">
                {{ profileData.department__name }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">合同年限：</span>
              <span class="labelCon promp">
                {{ profileData.contractTimeShow }}
              </span>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              ...
              <span class="labelCon promp">
                {{ profileData.checkWorkTypeShow }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">所任职务：</span>
              <span class="labelCon promp">
                {{ profileData.principalship__name }}
              </span>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              ...
              <span class="labelCon promp">
                {{ profileData.workGroup__name }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">宿舍分配：</span>
              <span class="labelCon promp">
                {{ profileData.liveDormitoryShow }}
              </span>
            </el-col>
            <el-col :span="12">
              <span class="labelCon">工作性质：</span>
              <span class="labelCon promp">
                {{ profileData.workNatureShow }}
              </span>
            </el-col>
            <el-col :span="12">
        ...
        <div class="drawer-profile">
          <el-row
            class="mb20"
            v-for="item in profileData.contractRecords"
            :key="item.id"
          >
            <el-col :span="12">
        ...
        <div class="drawer-profile flexImg">
          <div
            class="idCard"
            v-for="item in profileData.cardRecords"
            :key="item.id"
          >
            <p class="imgInfo">{{ item.cardName }}</p>
            <img
              class="posti"
              v-for="img in item.cardConnects"
              :key="img"
              :src="baseUrl + img"
              :data-img="img"
              alt
        ...
        <div class="drawer-profile">
          <el-row
            class="mb20"
            v-for="item in profileData.workRecords"
            :key="item.id"
          >
            <el-col :span="12">
        ...
        <div class="drawer-profile">
          <el-row
            class="mb20"
            v-for="item in profileData.educationRecords"
            :key="item.id"
          >
            <el-col :span="12">
            ...
            <el-col :span="12">
              <span class="labelCon">起止时间：</span>
              <span class="labelCon promp">
                {{ item.enduStartTime }} &nbsp;- &nbsp;{{ item.enduTime }}
              </span>
            </el-col>
            <el-col :span="12">
        ...
        <div class="drawer-profile">
          <el-row
            class="mb20"
            v-for="item in profileData.familyRecords"
            :key="item.id"
          >
            <el-col :span="12">
              <span class="labelCon">姓名：</span>
        ...
        <div class="drawer-profile">
          <el-row
            class="mb20"
            v-for="item in profileData.dutyRecords"
            :key="item.id"
          >
            <el-col :span="12">
              <span class="labelCon">入职日期：</span>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <div
            ...
            style="color:#0BB2D4;cursor:pointer"
            v-html="scope.row.employeeCode"
          ></div>
        </template>
      </vxe-table-column>
      ...
      <vxe-table-column
        v-for="field in table_field
          ...
          .filter(column => !column.fed_isvisiable)
          .filter(column => !column.isvisiable)"
        :key="field.name"
        :field="field.name"
...
export default {
  ...
  methods: {
    ...
    async fetchProfileData() {
      this.profileData = await this.$request.get(
        "hrm/detailmsg/" + this.staffId
      );
      // this.profileData =await this.$request.get('hrm/detailmsg/16036')
    },
    async remoteMethod(query) {
      if (query !== "") {
        this.introducerData = await api_common
          .resource("hrm/v2/quitstaff")
          .get({
            keyword: query,
            pagesize: 10
          });
