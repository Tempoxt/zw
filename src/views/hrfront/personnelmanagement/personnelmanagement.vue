                            ...
                            <el-row :gutter="40">
                                ...
                                <el-col :span="12">
                                    <el-row :gutter="0">
                                        ...
                                        <el-col :span="24" style="position: relative;" v-if="!isInsert">
                                            <el-button style="position: absolute;right:10px;top:52px" @click="identifyCard">识别身份证信息</el-button>
                                        </el-col>
                                    </el-row>
                                </el-col>
                            ...
                            <el-row :gutter="40">
                                <el-col :span="12">
                                    <el-row :gutter="20">
                                        ...
                                        <el-col :span="24">
                                            <form-render prop="department" :type="`department`" :field="{name:'所属部门',id:form.subCompany,disable:!isInsert}" :disabled="!isInsert" v-model="form.department"/>
                                        </el-col>
                                        <el-col :span="24">
