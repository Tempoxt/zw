 ...
 <el-row class="h-full">
    ...
    <el-col :span="19">
        ...
        <div v-if="view_activeName==='个人提成汇总'">
            <comissionRecordTable url="commission/presoncommcollect" :id="orgid"/>
        </div>
        <div v-if="view_activeName==='客户提成明细'">
            <comissionRecordTable url="commison/cuscommdetail" :id="orgid"/>
        </div>
        <div v-if="view_activeName==='收款提成明细'">
            <comissionRecordTable url="commission/receiptCommDetail" :id="orgid"/>
        </div>
    </el-col>
  </el-row>
</template>
